  ...
  return (0, import_auth_helpers_shared4.createServerSupabaseClient)({
    ...
    setCookie(name, value, options2) {
      ...
      const newSetCookies = (0, import_auth_helpers_shared4.filterCookies)(
        (0, import_auth_helpers_shared4.ensureArray)((_b = (_a2 = context.res.getHeader("set-cookie")) == null ? void 0 : _a2.toString()) != null ? _b : []),
        name
      );
...
function createMiddlewareSupabaseClient(context, {
  ...
  return (0, import_auth_helpers_shared4.createServerSupabaseClient)({
    ...
    getCookie(name) {
      var _a2;
      const cookies = (0, import_auth_helpers_shared4.parseCookies)((_a2 = context.req.headers.get("cookie")) != null ? _a2 : "");
      return cookies[name];
    },
    setCookie(name, value, options2) {
      const newSessionStr = (0, import_auth_helpers_shared4.serializeCookie)(name, value, {
    ...
    getRequestHeader: (key) => {
      var _a2;
      const header = (_a2 = context.req.headers.get(key)) != null ? _a2 : void 0;
      return header;
    },
    options: {
      ...options,
...
function createServerComponentSupabaseClient({
  ...
  return (0, import_auth_helpers_shared4.createServerSupabaseClient)({
    ...
    getCookie(name) {
      ...
      return (_a2 = nextCookies.get(name)) == null ? void 0 : _a2.value;
    },
    setCookie() {
    },
    options: {
